...
function getDbConfig(): DataSourceOptions {
  return {
    type: 'postgres',
    host: process.env.FLOTARA_TEST_DB_HOST,
    port: parseInt(process.env.FLOTARA_TEST_DB_PORT, 10),
    username: process.env.FLOTARA_TEST_DB_USERNAME,
    password: process.env.FLOTARA_TEST_DB_PASSWORD,
    database: process.env.FLOTARA_TEST_DB_DATABASE,
